guiPauseMenu() {
    ...
    createInterface(GUIPAUSETITLE, GUIOPTIONS . " +AlwaysOnTop",,,, "count-current", "destroyPauseMenu")
...
; flips kbmmode & resumes the current program
;
; returns null
kbmmodeResume() {
    global globalStatus
...
; flips suspendScript & resumes the current program
;
; returns null
suspendScriptResume() {
    global globalStatus
