...
buildLoadScreen(text := "Now Loading...") {

}

; an AHK script that checks if the loadscreen is shown
showLoadScreen(text := "Now Loading...") {

}

; an AHK script that updates the loadscreen with whatever args user passes
; NOTE - update should build and/or show loadscreen if its not
updateLoadScreen(text := "Now Loading...", toShow := true) {
